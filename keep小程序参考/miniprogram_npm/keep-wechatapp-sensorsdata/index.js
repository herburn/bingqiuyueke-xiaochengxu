var e, t, r, n = require("../../@babel/runtime/helpers/interopRequireDefault")(require("../../@babel/runtime/helpers/typeof"));
...
module.exports = (e = {}, r = function(t, r) {
    ...
    if (!e[t].status) {
        ...
        Object.keys(i.exports).forEach(function(r) {
            e[t].m.exports[r] = i.exports[r], Object.defineProperty(i.exports, r, {
                set: function(n) {
                    e[t].m.exports[r] = n;
                },
                get: function() {
...
})(1571054539772, function(e, t, r) {
    var i = {}, o = {};
    o.para = e("./sensorsdata_conf.js"), o.keepWechatappCommonHeader = {}, o.para.openid_url || (o.para.openid_url = o.para.server_url.replace(/\/sa(\.gif){0,1}/, "/mp_login")), 
    ...
    }, d = "直接打开", g = null, m = null, _ = 0, v = "", b = !1;
    o.lib_version = "1.10.3";
    var y = "object" === (0, n.default)(y) ? y : {};
    if (y.info = function() {
        if (o.para.show_log && "object" === ("undefined" == typeof console ? "undefined" : (0, 
        n.default)(console)) && console.log) try {
        ...
        i = 0; i < n; i++) {
            ...
            null !== s && (r > t && (o += e.substring(t, r)), o += s, t = r = i + 1);
        }
        ...
        return 2 !== (e = e.split("?")).length ? {} : (e = "?" + (e = e[1]), i.isArray(o.para.source_channel) && o.para.source_channel.length > 0 && (n = n.concat(o.para.source_channel), 
        ...
        if ("number" == typeof _ && 0 !== _) {
            var e = o.store.getDistinctId(), t = o.store.getFirstId();
            return !v || v !== e && v !== t ? _ + 1 : _;
        }
        return 1;
        ...
        "string" == typeof a ? (t.$share_distinct_id = a, v = a) : t.$share_distinct_id = "取值异常", 
        "number" == typeof n ? (t.$share_depth = n, _ = n) : t.$share_depth = "取值异常", t.$share_url_path = "string" == typeof o ? o : "取值异常";
    ...
    }, o._ = i, o.prepareData = function(e, t) {
        var r = {
        ...
        e.type && "profile" === e.type.slice(0, 7) || (r.properties = i.extend({}, i.info.properties, o.store.getProps(), r.properties), 
        "object" === (0, n.default)(o.store._state) && "number" == typeof o.store._state.first_visit_day_time && o.store._state.first_visit_day_time > new Date().getTime() ? r.properties.$is_first_day = !0 : r.properties.$is_first_day = !1), 
        ...
        i.searchObjDate(r), i.searchObjString(r), o.send(r, t);
    }, o.store = {
        storageInfo: null,
        getUUID: function() {
        ...
        set: function(e, t) {
            var r = {};
            for (var i in "string" == typeof e ? r[e] = t : "object" === (0, n.default)(e) && (r = e), 
            this._state = this._state || {}, r) this._state[i] = r[i];
            this.save();
        },
        change: function(e, t) {
            this._state[e] = t;
    ...
    }, o.pageShowTrack = function(e, t) {
        if (e) {
            var r = {};
            if (t) {
                if (!i.isObject(t)) return void y.info("the parameter properties of function pageShowTrack is not an object!");
                r = t;
            }
            g = {
                event: e,
        ...
        var S = function(e, t, r) {
            ...
            var r = i.setUtm(e, t);
            b ? (t.$is_first_time = !0, i.isEmptyObject(r.pre1) || o.setOnceProfile(r.pre1)) : t.$is_first_time = !1, 
            ...
            var t = {};
            m = new Date().getTime(), e && e.path && (t.$url_path = e.path), i.setShareInfo(e, t);
            var r = i.setUtm(e, t);
            i.isEmptyObject(r.pre2) || o.registerApp(r.pre2), e.scene = e.scene || "未取到值", t.$scene = i.getMPScene(e.scene), 
            o.registerApp({
                $latest_scene: t.$scene
            ...
            t.$url_path = i.getCurrentPath(), m && e - m > 0 && (e - m) / 36e5 < 24 && (t.event_duration = (e - m) / 1e3), 
            o.para.autoTrack && o.para.autoTrack.appHide && o.autoTrackCustom("appHide", t, "$MPHide");
        }, C = App;
        App = function(e) {
            S(e, "onLaunch", O), S(e, "onShow", x), S(e, "onHide", j), C(e);
        };
        var I = Page;
        Page = function(e) {
            if (S(e, "onLoad", function(e) {
                if (e && i.isObject(e)) {
                    var t = i.extend({}, e);
                ...
                var e = "系统没有取到值";
                "object" === (0, n.default)(this) && ("string" == typeof this.route ? e = this.route : "string" == typeof this.__route__ && (e = this.__route__));
                var t = {};
                if (t.$referrer = d, t.$url_path = e, this.sensors_mp_load_utm && (i.extend(t, this.sensors_mp_load_utm), 
                this.sensors_mp_load_utm = null), g) {
                    var r = i.isEmptyObject(g.prop) ? t : i.extend(t, g.prop);
                    o.track(g.event, r), g = null;
                } else o.para.onshow ? o.para.onshow(o, e, this) : o.autoTrackCustom("pageShow", t, "$MPViewScreen");
                d = e;
    ...
    return r({
        "./sensorsdata_conf.js": 1571054539773
    }[e], e);
}), t(1571054539773, function(e, t, r) {
    t.exports = {
        name: "sensors",
        appid: "",
        server_url: "",
