...
var superRank = require("./superRank.js");

module.exports = {
    responseRegionIdMap: _objectSpread({}, superRank.responseRegionIdMap),
    responseRegionConfigMap: _objectSpread({}, superRank.responseRegionConfigMap)
};