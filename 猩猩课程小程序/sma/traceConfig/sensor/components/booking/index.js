...
var bookingSuccessBody = require("./bookingSuccessBody.js");

module.exports = {
    responseRegionIdMap: _objectSpread({}, bookingSuccessBody.responseRegionIdMap),
    responseRegionConfigMap: _objectSpread({}, bookingSuccessBody.responseRegionConfigMap)
};