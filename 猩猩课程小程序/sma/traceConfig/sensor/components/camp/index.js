...
var selectCampModal = require("./selectCampModal.js"), campListCard = require("./campListCard.js");

module.exports = {
    responseRegionIdMap: _objectSpread({}, selectCampModal.responseRegionIdMap, {}, campListCard.responseRegionIdMap),
    responseRegionConfigMap: _objectSpread({}, selectCampModal.responseRegionConfigMap, {}, campListCard.responseRegionConfigMap)
};