...
var my = require("./my.js"), rechargeConfirm = require("./rechargeConfirm.js");

module.exports = {
    responseRegionIdMap: _objectSpread({}, my.responseRegionIdMap, {}, rechargeConfirm.responseRegionIdMap),
    responseRegionConfigMap: _objectSpread({}, my.responseRegionConfigMap, {}, rechargeConfirm.responseRegionConfigMap)
};