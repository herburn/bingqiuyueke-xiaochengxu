...
var bannerCourseList = require("./bannerCourseList.js");

module.exports = {
    responseRegionIdMap: _objectSpread({}, bannerCourseList.responseRegionIdMap),
    responseRegionConfigMap: _objectSpread({}, bannerCourseList.responseRegionConfigMap)
};