...
var dataDisplay = require("./dataDisplay.js");

module.exports = {
    responseRegionIdMap: _objectSpread({}, dataDisplay.responseRegionIdMap),
    responseRegionConfigMap: _objectSpread({}, dataDisplay.responseRegionConfigMap)
};