...
var bookingSuccess = require("./bookingSuccess.js");

module.exports = {
    responseRegionIdMap: _objectSpread({}, bookingSuccess.responseRegionIdMap),
    responseRegionConfigMap: _objectSpread({}, bookingSuccess.responseRegionConfigMap)
};