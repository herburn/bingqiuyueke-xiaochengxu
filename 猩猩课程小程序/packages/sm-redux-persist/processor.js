Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.default = persistPocessor;

var _dependent = require("./dependent.js"), _reduxPersist = require("./../redux-persist/index.js");
...
function persistPocessor(e) {
    return e.key in _dependent.persistConfig ? _objectSpread({}, e, {
        reducers: (0, _reduxPersist.persistReducer)(_dependent.persistConfig[e.key], e.reducers)
    }) : e;
}