...
var _default = _defineProperty({}, _actionTypes.NOVICE_CLASS_LIST_GET, _asyncToGenerator(_regeneratorRuntime2.default.mark(function e() {
    var r;
    return _regeneratorRuntime2.default.wrap(function(e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return r = "".concat(_common.generalBase, "/wxNoviceClass/getNoviceClass"), e.prev = 1, 
          ...
          case 7:
            throw e.prev = 7, e.t0 = e.catch(1), console.log("NOVICE_CLASS_LIST_GET error", e.t0.rtn, e.t0.msg), 
            e.t0;
